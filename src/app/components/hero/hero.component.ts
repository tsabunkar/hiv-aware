...
@Component({
    ...
    <section class="hero" id="home">
      ...
      <div class="hero-content container">
        <div class="hero-label">
          ...
          <span class="font-mono">World Health Initiative</span>
        </div>
        ...
        <p class="hero-sub">
          HIV is not a death sentence. With the right knowledge, prevention strategies,
          and modern treatment, millions live full, healthy lives. Start here.
        </p>
        ...
        <div class="hero-stats">
          ...
          <div class="stat">
            ...
            <span class="stat-label">On life-saving antiretroviral therapy</span>
          </div>
          <div class="stat-divider"></div>
          <div class="stat">
  ...
  styles: [`
    .hero {
      ...
      position: relative;
      overflow: hidden;
      background: radial-gradient(ellipse at 70% 50%, rgba(200, 16, 46, 0.12) 0%, transparent 60%),
                  radial-gradient(ellipse at 20% 80%, rgba(26, 176, 160, 0.05) 0%, transparent 50%),
                  var(--black);
    }
